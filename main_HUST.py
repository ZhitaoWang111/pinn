...
def get_args():
    ...
    parser.add_argument('--save_folder', type=str, default='PINN4SOH/results/HUST_results{timestamp}', help='save folder')
...
def main():
    ...
    for e in range(10):
        setattr(args, 'save_folder', f'PINN4SOH/results/HUST_results{timestamp}/Experiment{e + 1}')
...
def small_sample():
    ...
    for n in [1,2,3,4]:
        for e in range(10):
            setattr(args,'save_folder',f'PINN4SOH/results/HUST results (small sample {n})/Experiment{e+1}')
